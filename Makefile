...
dearmor: keys/keybase-20190624.asc.gpg keys/tarsnap-signing-key-2020.asc.gpg keys/python-Lukasz-Langa-keybase.asc.gpg keys/bintray-public.key.asc.gpg keys/trava90.asc.gpg
